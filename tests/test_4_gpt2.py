...
def test_gpt2_1(get_ip: str, get_port: int, get_driver: webdriver.Chrome):
    ...
    model_select = Select(driver.find_element(by=By.ID, value="Model"))
    ...
    model_select.select_by_visible_text("GPT-2")
...
def test_gpt2_2(get_ip: str, get_port: int, get_driver: webdriver.Chrome):
    ip, port, driver = get_ip, get_port, get_driver
...
def test_gpt2_3(get_ip: str, get_port: int, get_driver: webdriver.Chrome):
    ip, port, driver = get_ip, get_port, get_driver
    driver.get(f'http://{ip}:{port}/generate/neural')
